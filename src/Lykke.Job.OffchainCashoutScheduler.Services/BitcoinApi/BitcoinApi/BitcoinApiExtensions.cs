...
namespace Lykke.Job.OffchainCashoutScheduler.BitcoinApi
{
    ...
    public static partial class BitcoinApiExtensions
    {
            ...
            {
                return operations.ApiOffchainCreatecashinPostAsync(model).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> ApiOffchainCreatecashinPostAsync(this IBitcoinApi operations, CreateCashinModel model = default(CreateCashinModel), CancellationToken cancellationToken = default(CancellationToken))
            {
